...
public record AesKeyFileMetadata(int KeySizeInBytes, int IVSizeInBytes, EncodingType TextEncodingType, string EncodingName, string FileVersion, string Description = "AES key file")
{
    /// <summary>
